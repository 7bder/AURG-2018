...
\begin{figure}[htp]
    ...
    \centering
    \fbox{\includegraphics[width=1\linewidth]{StationDistribution}}
\end{figure}
...
\begin{figure}[htp]
    ...
    \centering
    \fbox{\includegraphics[width=1\linewidth]{DataCleaning}}
\end{figure}
...
\begin{figure}[htp]
    ...
    \centering
    \fbox{\includegraphics[width=1\linewidth]{AgeDistribution}}
\end{figure}
...
\begin{figure}[htp]
    ...
    \centering
    \fbox{\includegraphics[width=1\linewidth]{DurationDistribution}}
\end{figure}
...
\begin{figure}[htp]
    ...
    \centering
    \fbox{\includegraphics[width=1\linewidth]{RandomForests}}
\end{figure}
...
\begin{figure}[htp]
    ...
    \centering
    \includegraphics[width=0.7\linewidth]{Prediction5Min}\\
    \includegraphics[width=0.7\linewidth]{Prediction8Min}\\
    \includegraphics[width=0.7\linewidth]{Prediction13Min}\\
\end{figure}
